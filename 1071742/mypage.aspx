...
<body style="background-color:#DFD5BC;">
    ...
    <form id="form1" runat="server">
        ...
        <div>
            `````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````qq1q1<asp:Label ID="Label1" runat="server"></asp:Label>
            ...
            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:1082netdbAConnectionString %>" SelectCommand="SELECT Id, schedule_name, schedule_date, schedule_dateline FROM s1071742_projectDATE WHERE(Id=@id)" UpdateCommand="UPDATE s1071742_projectDATE SET schedule_dateline = @dateline WHERE (schedule_name=@datename)">
                <SelectParameters>
            ...
            &nbsp;
            <asp:Label ID="dateline" runat="server" Visible="False"></asp:Label></p>
            <br />
            <br />
        </div>
    </form>
